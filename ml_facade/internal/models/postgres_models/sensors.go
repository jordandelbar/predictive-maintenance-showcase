	...
	for _, record := range records {
		batch.Queue(`
			INSERT INTO monitoring (
				machine_id, record_id, sensor_00, sensor_01, sensor_02, sensor_03, sensor_04, sensor_05, sensor_06,
			...
			record.SensorData.MachineID, record.SensorData.RecordID, record.SensorData.Sensor00, record.SensorData.Sensor01,
			...
			record.SensorData.Sensor50, record.SensorData.Sensor51, record.ReconstructionError, record.Anomaly,
			record.AnomalyCounter, record.Origin,
		)
	}
