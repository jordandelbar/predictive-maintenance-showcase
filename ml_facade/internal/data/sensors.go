...
type Sensor struct {
	...
	Sensor52 float64 `json:"sensor_52"`
}
...
func (s SensorModel) Insert(record *Record) error {
	query := `
		INSERT INTO monitoring (
			sensor_00, sensor_01, sensor_02, sensor_03, sensor_04, sensor_05, sensor_06, sensor_07, sensor_08,
			sensor_09, sensor_10, sensor_11, sensor_12, sensor_13, sensor_14, sensor_15, sensor_16, sensor_17,
			...
			sensor_36, sensor_37, sensor_38, sensor_39, sensor_40, sensor_41, sensor_42, sensor_43, sensor_44,
			sensor_45, sensor_46, sensor_47, sensor_48, sensor_49, sensor_50, sensor_51, sensor_52, reconstruction_error
		) VALUES (
	...
	args := []any{
		record.SensorData.Sensor00, record.SensorData.Sensor01, record.SensorData.Sensor02, record.SensorData.Sensor03,
		record.SensorData.Sensor04, record.SensorData.Sensor05, record.SensorData.Sensor06, record.SensorData.Sensor07,
		record.SensorData.Sensor08, record.SensorData.Sensor09, record.SensorData.Sensor10, record.SensorData.Sensor11,
		record.SensorData.Sensor12, record.SensorData.Sensor13, record.SensorData.Sensor14, record.SensorData.Sensor15,
		record.SensorData.Sensor16, record.SensorData.Sensor17, record.SensorData.Sensor18, record.SensorData.Sensor19,
		record.SensorData.Sensor20, record.SensorData.Sensor21, record.SensorData.Sensor22, record.SensorData.Sensor23,
		record.SensorData.Sensor24, record.SensorData.Sensor25, record.SensorData.Sensor26, record.SensorData.Sensor27,
		record.SensorData.Sensor28, record.SensorData.Sensor29, record.SensorData.Sensor30, record.SensorData.Sensor31,
		record.SensorData.Sensor32, record.SensorData.Sensor33, record.SensorData.Sensor34, record.SensorData.Sensor35,
		record.SensorData.Sensor36, record.SensorData.Sensor37, record.SensorData.Sensor38, record.SensorData.Sensor39,
		record.SensorData.Sensor40, record.SensorData.Sensor41, record.SensorData.Sensor42, record.SensorData.Sensor43,
		record.SensorData.Sensor44, record.SensorData.Sensor45, record.SensorData.Sensor46, record.SensorData.Sensor47,
		record.SensorData.Sensor48, record.SensorData.Sensor49, record.SensorData.Sensor50, record.SensorData.Sensor51,
		record.SensorData.Sensor52, record.ModelResponse.ReconstructionError,
	}
